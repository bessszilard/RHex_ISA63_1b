...
nVar = 5;               % number of Unknowon (Deciison) Variables - dimensions of search space
...
VarMin = [tpLim(1) tsLim(1) psziSLim(1) alphaLim(1) k_Lim(1)];    % Lower Bound of Decision Variable
VarMax = [tpLim(2) tsLim(2) psziSLim(2) alphaLim(2) k_Lim(2)];    % Upper Bound of Decision Variable
